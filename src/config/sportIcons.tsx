...
// with no entry here automatically falls back to its 2-letter `mono`, so adding
// a sport never breaks the rail. Giving it an icon later is a 4-line addition.
// ============================================================================
...
export const SPORT_ICONS: Record<string, ReactNode> = {
  football: (
    <Svg>
